...
@section('parentPageTitle', 'Campaign Template')
@section('page-style')
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h2><strong>Campaign Template</strong> Mapping</h2>
            </div>
            <div class="body">
                <form class="form-horizontal" action="{{ action('CampaignController@store') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="email" id="from_email" name="from_email" class="form-control" placeholder="Enter Frame Name" required>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8">
                            <div class="form-group">
                                <input type="email" id="reply_to" name="reply_to" class="form-control" placeholder="Enter Reply to" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="checkbox" id="track_open" value=true name="track_open" class="custom-control-input">
                                <label class="custom-control-label" for="track_open">Track opens</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="checkbox" value=true id="track_click" name="track_click" class="custom-control-input">
