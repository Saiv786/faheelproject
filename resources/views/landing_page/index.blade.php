	...
	<div class="container">
		...
		<div class="row">
			...
			<div style="text-align: center; display: grid; align-items: center;" class="col-md-6">
				<div>
					<button id="sub_switcher1" class="btn btn-md btn-black">Switch to Subscription Pricing</button>
				</div>
				<div>
...
<script type="text/javascript">
	...
	document.getElementById("sub_switcher1").addEventListener("click", function() {
		...
		document.getElementById("sub_switcher1").classList.add('btn-primary');
		document.getElementById("sub_switcher1").classList.remove('btn-black');
		document.getElementById("sub_switcher2").classList.add('btn-black');
		document.getElementById("sub_switcher2").classList.remove('btn-primary');
	...
	document.getElementById("sub_switcher2").addEventListener("click", function() {
		...
		document.getElementById("sub_switcher2").classList.add('btn-primary');
		document.getElementById("sub_switcher2").classList.remove('btn-black');
		document.getElementById("sub_switcher1").classList.add('btn-black');
		document.getElementById("sub_switcher1").classList.remove('btn-primary');
	});
</script>
