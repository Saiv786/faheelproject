			...
			<header id="header" class="header tra-menu navbar-light">
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">	
				    	...
				    	<span class="smllogo smllogo-black"><h1>Osmly Mail</h1></span>
				    	<span class="smllogo smllogo-white"><h1 style="color: White">Osmly Mail</h1></span>
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo"><a href="#hero-10" class="logo-black"><h1>Osmly Mail</h1></a></div>
	    					<div class="desktoplogo"><a href="#hero-10" class="logo-white"><h1 style="color: White">Osmly Mail</h1></a></div>
